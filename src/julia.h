...
JL_DLLEXPORT jl_value_t *jl_restore_incremental(jl_module_t *into, const char *fname, jl_array_t *depmods);
JL_DLLEXPORT jl_value_t *jl_restore_incremental_from_buf(jl_module_t *into, const char *buf, size_t sz, jl_array_t *depmods);
